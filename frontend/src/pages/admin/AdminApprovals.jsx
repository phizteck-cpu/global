    ...
    const handleAction = async (id, status) => {
        ...
        try {
            if (status === 'SUCCESS') {
                ...
                await api.post(`/withdrawals/reject/${id}`);
        ...
        <div className="space-y-10 animate-fade-in pb-20">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6 bg-gradient-to-br from-slate-900 to-black p-10 rounded-[3rem] border border-white/5 shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-2">
                    ...
                    <p className="text-noble-gray italic font-light max-w-md">Authorized scrutiny for outbound capital transfers.</p>
                </div>

                <div className="relative z-10 flex flex-col items-end">
                    <p className="text-[10px] uppercase tracking-[0.2em] font-black text-noble-gray mb-1">Queue Capitalization</p>
