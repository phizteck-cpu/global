...
const AdminOverview = () => {
    ...
    const metrics = [
        ...
        { label: 'Cooperative Assets', value: `₦${stats.totalAssets?.toLocaleString()}`, icon: Anchor, color: 'text-emerald-400', sub: 'Member CaxiosClienttal', trend: 'stable' },
                ...
                <div className="lg:col-span-4 space-y-6">
                    <div className="glass-card p-8 rounded-[3rem] border-white/5 relative overflow-hidden">
                        ...
                        <div className="space-y-6">
                            <HealthItem label="axiosClient Response" efficiency="99.9%" />
